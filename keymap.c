...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
      ...
      ADJUST,  KC_ESC,  KC_LALT, KC_LGUI, LOWER,   KC_ENT,  EISU,    KANA,    KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
      ),
   ...
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
   * | TAB  |   '  |   ,  |   .  |   P  |   Y  |             |   G  |   R  |   L  |   C  |   F  | BSPC |
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
   * | Ctrl |   A  |   O  |   E  |   I  |   U  |             |   D  |   H  |   T  |   N  |   S  | Ctrl |
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * | Alt  |   ;  |   Q  |   J  |   K  |   X  |      |      |   B  |   M  |   W  |   V  |   Z  | Alt  |
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |Adjust| Left | Down | GUI  | LSFT |Enter | EISU | KANA |Space | RSFT | GUI  |  Up  |Right |Adjust|
   * `-------------------------------------------------------------------------------------------------'
   */
  [_DVORAK] = LAYOUT( \
      ...
      ADJUST,  KC_LEFT, KC_DOWN, KC_LGUI, LOWER,   KC_ENT, EISU,    KANA,    KC_SPC,  RAISE,   KC_RGUI, KC_UP,   KC_RGHT, ADJUST   \
  ),
  ...
  [_NICOLA] = LAYOUT( \
      ...
      _______, _______, _______, _______, NG_SHFTL,_______, _______, _______, _______, NG_SHFTR,_______, _______, _______, _______ \
      ),
  // NICOLA親指シフト
  ...
  /* Lower
     ...
     */
    [_LOWER] = LAYOUT( \
        _______, KC_DLR,  KC_AT,   KC_HASH, KC_PERC, KC_EXLM,                   KC_QUES, KC_UNDS, KC_EQL,  KC_PLUS, KC_TILD, _______, \
        _______, KC_DQUO, KC_RPRN, KC_LPRN, S(KC_P), S(KC_Y),                   S(KC_G), S(KC_R), S(KC_L), S(KC_F), S(KC_C), _______,  \
        _______, S(KC_A), S(KC_O), S(KC_E), S(KC_I), S(KC_U),                   S(KC_D), S(KC_H), S(KC_T), S(KC_N), S(KC_S), _______, \
        _______, KC_COLN, S(KC_Q), S(KC_J), S(KC_K), S(KC_X), _______, KC_DEL,  S(KC_B), S(KC_M), S(KC_W), S(KC_V), S(KC_Z), _______, \
     ...
     * |      |  -   |      |      |      |      |      |      |      |      |      |      |      |      |
     * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
     * |      | HOME | PGDW |      |      |      | CAPS |      |      |      |      | PGUP | END  |      |
     * `-------------------------------------------------------------------------------------------------'
     */
    [_RAISE] = LAYOUT( \
        _______, KC_SLSH, KC_PIPE, KC_BSLS, KC_LBRC, KC_RBRC,                   KC_LABK, KC_RABK, KC_ASTR, KC_CIRC, KC_AMPR, _______, \
        _______, KC_GRV,  KC_LCBR, KC_RCBR, S(KC_P), S(KC_Y),                   S(KC_G), S(KC_R), S(KC_L), S(KC_F), S(KC_C), _______,  \
        _______, S(KC_A), S(KC_O), S(KC_E), S(KC_I), S(KC_U),                   S(KC_D), S(KC_H), S(KC_T), S(KC_N), S(KC_S), _______, \
        _______, KC_MINS, S(KC_Q), S(KC_J), S(KC_K), S(KC_X), _______, KC_DEL,  S(KC_B), S(KC_M), S(KC_W), S(KC_V), S(KC_Z), _______, \
        _______, KC_HOME, KC_PGDN, _______, _______, _______, KC_CAPS, _______, _______, _______, _______, KC_PGUP, KC_END,  _______ \
    ),
     ...
     * |------+------+------+------+------+------|             |------+------+------+------+------+------|
     * |      | Reset|      |      |      |      |             | Ins  |Print | App  |SCLLOC|Pause |      |
     * |------+------+------+------+------+------|             |------+------+------+------+------+------|
     * |      |      |      |Aud on|Audoff| Mac  |             | Win  |Qwerty|tsubak|      |      |      |
     * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
     * |      | B up |B down|      |      |      |      | Prev | Play | Next | Mute | Vol- | Vol+ |      |
     * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
     * |      |      |      |      |      |      |      |      |      |      |      |      |      |      |
     * `-------------------------------------------------------------------------------------------------'
     */
    [_ADJUST] =  LAYOUT( \
        ...
        _______, RESET,   _______, _______, _______, _______,                   KC_INS,  KC_PSCR, KC_APP,  KC_SLCK, KC_PAUS, _______, \
